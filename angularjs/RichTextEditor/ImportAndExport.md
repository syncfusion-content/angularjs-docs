---
layout: post
title: Import and Export in AngularJS RichTextEditor widget | Syncfusion 
...
---
# Import and Export in AngularJS Rich TextEditor 
...
{% highlight html %}
    ...
    <script type="text/javascript" class="jsScript">
        ...
        angular.module('rteApp', ['ejangular'])
        .controller('RTECtrl', function ($scope) {
            $scope.wordurl = "http://js.syncfusion.com/ejServices/api/RTE/WordExport";
