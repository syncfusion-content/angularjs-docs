...
<body>
    <div ng-controller="PivotClientCtrl">
        ...
        <div id="PivotClient1" ej-pivotclient />
    </div>
</body>
</html>
...
<body>
    <div ng-controller="PivotClientCtrl">
        <div id="PivotClient1" ej-pivotclient e-datasource="dataSource" e-title="Relational Browser" />
    </div>
    <script>
...
<body>
    <div ng-controller="PivotClientCtrl">
        <div id="PivotClient1" ej-pivotclient e-url="url" e-title="Relational Browser" />
    </div>
    <script>
        angular.module('PivotClientApp', ['ejangular']).controller('PivotClientCtrl', function ($scope) {
