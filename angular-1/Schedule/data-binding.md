...
<body>
    <div ng-controller="ScheduleCtrl">
        <ej-schedule id="Schedule1" e-width="100%" e-height="525px" e-currentdate="setDate" e-showlocationfield="true" e-categorizesettings-enable="true" e-prioritysettings-enable="true"
            e-appointmentsettings-datasource="appointments" e-appointmentsettings-resourcefields="ownerId" e-appointmentsettings-categorize="Categorize" e-appointmentsettings-priority="Priority" e-group="group">
            <e-resources>                       
...
<body>
    <div ng-controller="ScheduleCtrl">
        <ej-schedule id="Schedule1" e-width="100%" e-height="525px" e-currentdate="setDate" e-showlocationfield="true" e-categorizesettings-enable="true"
            ...
            e-appointmentsettings-location="Location"
            e-appointmentsettings-categorize="Categorize">
        </ej-schedule>
    </div>
    <script type="text/javascript">
        ...
        angular.module('ScheduleApp', ['ejangular']).controller('ScheduleCtrl', function ($scope) {
            $scope.Subject = { field: "Subject", validationRules: { required: true } };
            $scope.Location = { field: "Location", validationRules: { required: true, customRule: "/^[a-zA-Z0-9- ]*$/" } };
            $scope.StartTime = { field: "StartTime", validationRules: { required: true } };
            $scope.EndTime = { field: "EndTime", validationRules: { required: true } };
            $scope.Description = { field: "Description", validationRules: { required: true, minlength: 5, maxlength: 500 } };
            $scope.Categorize = { field: "Categorize", validationRules: { required: true, messages: { required: "Categories are required." } } };
            $scope.appointments = [{
                Id: 1,
                Subject: "Music Class",
                StartTime: new Date(2017, 1, 7, 9, 00),
...
<body>
    <div ng-controller="ScheduleCtrl">
        <ej-schedule id="Schedule1" e-width="100%" e-height="525px" e-currentdate="setDate" e-appointmentsettings-datasource="dataManager" e-appointmentsettings-query="queryEvent">
        </ej-schedule>
    </div>
    <script type="text/javascript">
        angular.module('ScheduleApp', ['ejangular']).controller('ScheduleCtrl', function ($scope) {
            ...
            $scope.queryEvent = ej.Query().from("Events").take(10);
...
<body>
    <div ng-controller="ScheduleCtrl">
        <ej-schedule id="Schedule1" e-width="100%" e-height="525px" e-currentdate="setDate"
            e-appointmentsettings-datasource="dataManager"
            e-appointmentsettings-subject="ShipName"
            e-appointmentsettings-starttime="OrderDate"
            e-appointmentsettings-endtime="RequiredDate"
            e-appointmentsettings-description="ShipAddress">
        </ej-schedule>
    </div>
    <script type="text/javascript">
        angular.module('ScheduleApp', ['ejangular']).controller('ScheduleCtrl', function ($scope) {
            ...
            $scope.setDate = new Date(1997, 2, 23);
        });
    </script>
</body>
</html>
...
The **e-enableloadondemand** property is used to enable or disable the load on demand functionality of the schedule.
...
<body>
    <div ng-controller="ScheduleCtrl">
        <ej-schedule id="Schedule1" e-width="100%" e-height="525px" e-currentdate="setDate" e-enableloadondemand="true" e-appointmentsettings-datasource="dataManager">            
        </ej-schedule>
    </div>
    <script type="text/javascript">
        angular.module('ScheduleApp', ['ejangular']).controller('ScheduleCtrl', function ($scope) {
