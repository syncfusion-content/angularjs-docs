...
<body ng-controller="SpreadsheetCtrl">
     <div id="Spreadsheet" ej-spreadsheet e-sheets="sheetData" e-rowcount =50 e-columncount =36></div>
</body>
{% endhighlight %}
...
{% highlight html %}
<body ng-controller="SpreadsheetCtrl">
     <div id="Spreadsheet" ej-spreadsheet e-loadcomplete="loadComplete" e-sheets="sheetData" e-allowinsert ="true" e-allowdelete ="true"></div>
</body>
{% endhighlight %}
